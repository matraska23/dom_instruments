...
var $4 = {
	...
	// @memberOf $4 - find parent element by selector string
	// @param {HtmlElement} node
	...
	// @memberOf $4 - execute callback function for all neighbor elements
	// @param {HtmlElement} node
	// @param {Function} cb - callback for neighbour elements
